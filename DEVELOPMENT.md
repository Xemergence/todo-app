...
```bash
git remote add encore encore://todo-app-d6xi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/todo-app-d6xi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/todo-app-d6xi/settings/integrations/github)
